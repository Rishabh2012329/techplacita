    ...
    return (<div>
        <div style={{display:"flex",alignItems:"center",flexDirection:"column",padding:"20px"}}>
            ...
            <div id="fg" style={{display:"flex",flexDirection:"row",width:"90%",marginTop:"5px",justifyContent:"space-between"}}>
                ...
                Techplacita set an exemplary model of communal service by providing care for the Santa Clara Medical Center, Kaiser in Fremont’s ER department and other Bay Area Hospitals during the COVID 19 pandemic. Some of the departments that were hit the hardest in the Bay Area were the Respiratory and ER departments. Providing the food packets and care kits to the hospitals and the underprivileged communities was a small effort by Techplacita to create a path to follow and uplift the brave deed of #healthcareheroes.<br/><br></br>
