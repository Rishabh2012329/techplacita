...
export default function Header() {
    ...
    <li data-target="#carouselExampleIndicators" data-slide-to="2"></li>
        ...
        <div style={{zIndex:"3",bottom:"40px",position:"absolute",fontSize:"25px",animation:"bounce 1.2s Infinite",display:'flex',justifyContent:"center",alignItems:"center",width:"100%"}}>
               <FaChevronDown color="white" style={{top:"10px",position:"absolute"}}/>
           </div>
